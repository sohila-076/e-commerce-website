...
const Header = () => {
  ...
  return (
    <header className="relative w-full min-h-[70vh] md:min-h-[70vh] flex flex-col items-center justify-center overflow-hidden font-['Poppins'] bg-[#E0F7FA] px-4 sm:px-8 md:px-12 py-16">
      <AnimatedBackground />
