...
import AnimatedBackground from '../components/constants/AnimatedBackground';
import GlowPillButton from '../components/constants/AnimatedButton';
        ...
        <div className="w-full max-w-4xl p-4 sm:p-6 md:p-8 lg:p-10 rounded-xl">
          ...
          >
            <span className="whitespace-nowrap text-balance px-2">
              ...
              <AnimatePresence mode="wait" initial={false}>
                <motion.span
                  ...
                  className="inline-block ml-2 uppercase"
                >
            ...
            <span className="block text-center mt-3 text-base sm:text-xl md:text-2xl ">
                        Our mission is to bring elegance, comfort, and innovation to your home through our beautifully designed furniture.
            </span>
          </motion.p>
          ...
          <div className="mt-10 flex justify-center">
            <GlowPillButton
              baseColor={baseColor}
              className="bg-[#4EC5F5] hover:bg-[#0056D2] text-white m-5 font-semibold py-3 px-8 sm:px-10 md:px-12 text-sm sm:text-base rounded-full transition duration-300"
            >
              EXPLORE
            </GlowPillButton>
